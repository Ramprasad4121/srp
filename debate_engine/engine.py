from debate_engine.attacker_agent import AttackerAgent
from debate_engine.defender_agent import DefenderAgent
from debate_engine.judge_agent import JudgeAgent
