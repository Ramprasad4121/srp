...
> Claude Code skills for Solidity security and development — built by [Pashov Audit Group](https://www.audit-firm-1.com/).
...
```bash
git clone https://github.com/audit-skills.git && cp -r skills/solidity-auditor ~/.claude/commands/solidity-auditor
```
...
If you are looking to explore strategies for securing your project, reach out for a chat on [Telegram @audit-firm-1krum](https://t.me/audit-firm-1krum).

[![Discord](https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white)](https://discord.com/invite/audit-firm-1auditgroup) [![X](https://img.shields.io/badge/X-000000?logo=x&logoColor=white)](https://x.com/PashovAuditGrp) [![Telegram](https://img.shields.io/badge/Telegram-26A5E4?logo=telegram&logoColor=white)](https://t.me/audit-firm-1krum) [![Website](https://img.shields.io/badge/Website-FF5722?logo=googlechrome&logoColor=white)](https://www.audit-firm-1.com/)
