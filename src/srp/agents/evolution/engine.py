...
from srp.agents.evolution.mutator import Mutator
from srp.agents.evolution.crossover import Crossover
from srp.agents.evolution.evaluator import Evaluator

class EvolutionEngine:
    def __init__(self, mcp=None, skill_store=None, history_dir="evolution_history"):
        from srp.agents.learning.skill_store import SkillStore
        self.mcp = mcp
