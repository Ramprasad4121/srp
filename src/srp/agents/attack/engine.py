...
class AttackEngine:
    def __init__(self):
        from srp.agents.attack.strategies.flashloan import FlashloanStrategy
        from srp.agents.attack.strategies.oracle import OracleManipulationStrategy
        from srp.agents.attack.strategies.reentrancy import ReentrancyProbeStrategy
